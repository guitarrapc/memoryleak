...
using DiagnosticCore.Portability.Extensions;
...
namespace DiagnosticCore.Portability
{
    ...
    internal static class RuntimeInformation
    {
        ...
        internal static string GetRuntimeVersion()
        {
            ...
            {
                string runtimeVersion = DiagnosticCore.Portability.Environments.Runtimes.CoreRuntime.TryGetVersion(out var version) ? version.ToString() : "?";
        ...
        internal static Runtime GetCurrentRuntime()
        {
            ...
            if (IsFullFramework)
                return DiagnosticCore.Portability.Environments.Runtimes.ClrRuntime.GetCurrentVersion();
            if (IsNetCore)
                return DiagnosticCore.Portability.Environments.Runtimes.CoreRuntime.GetCurrentVersion();
            if (IsCoreRT)
                return DiagnosticCore.Portability.Environments.Runtimes.CoreRtRuntime.GetCurrentVersion();
